...
crudini --set $cfg DEFAULT s3_host "${NOVA_SERVICE_HOST}"
...
crudini --set $cfg vnc xvpvncproxy_base_url "http://${NOVA_SERVICE_HOST}:6081/console"
crudini --set $cfg vnc novncproxy_base_url "http://${NOVA_SERVICE_HOST}:6080/vnc_auto.html"


crudini --set $cfg spice enabled "false"
crudini --set $cfg spice html5proxy_base_url "http://${NOVA_SERVICE_HOST}:6082/spice_auto.html"
