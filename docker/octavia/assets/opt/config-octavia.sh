...
crudini --set $cfg keystone_authtoken project_id "7804edd9e59b417cb24c0205d33c85fe"
...
etcdctl get /octavia/ssh/private_key | base64 -d > /etc/octavia/.ssh/octavia_ssh_key
chmod 0600 /etc/octavia/.ssh/octavia_ssh_key
etcdctl get /octavia/ssh/public_key | base64 -d > /etc/octavia/.ssh/octavia_ssh_key.pub
...
OCTAVIA_AMP_NETWORK_ID="$(etcdctl get /octavia/controller_worker/amp_boot_network_list)"
crudini --set $cfg controller_worker amp_boot_network_list "${OCTAVIA_AMP_NETWORK_ID}"
crudini --set $cfg controller_worker amp_image_tag "amphora"
OCTAVIA_MGMT_SEC_GRP_ID="$(etcdctl get /octavia/controller_worker/amp_secgroup_list)"
crudini --set $cfg controller_worker amp_secgroup_list "${OCTAVIA_MGMT_SEC_GRP_ID}"
