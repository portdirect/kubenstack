...
openstack user create --project "service" --password "password" --enable "octavia"
openstack role add --project "service" --user "octavia" "admin"
openstack role add --domain "default" --user "octavia" "admin"
openstack service create --name "octavia" --description "OpenStack Octavia" "octavia"
openstack endpoint create --region "RegionOne" "octavia" public "http://${CONTROLLER_IP}:9876"
openstack endpoint create --region "RegionOne" "octavia" internal "http://${CONTROLLER_IP}:9876"
openstack endpoint create --region "RegionOne" "octavia" admin "http://${CONTROLLER_IP}:9876"
